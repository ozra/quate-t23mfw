...
class bad_quantbuffer_indexing: public bad_quantbuffer_use {  //  - 2014-08-12/ORC(19:51)
  public:
    virtual const char* what() const throw() {
...
class bad_quantbuffer_allocation: public bad_quantbuffer_use {  //  - 2014-08-12/ORC(19:51)
  public:
    virtual const char* what() const throw() {
