...
template <> void QuantStudyContext<true>::finalize_plot () {
    ...
    // *TODO* enum_annotation_type : LINE, ARROW, ELLIPSE, RECT, etc. etc. 141010
        plot_stream << "[ " << enum_plot_type::CIRCLE << ", 123123, 11.14, 900, 0.04, \"grp2\" ] ";
    // }
...
template <> void QuantStudyContext<false>::set_plot_group ( Str ) {
}
//#pragma GCC diagnostic pop

template <> void QuantStudyContext<true>::set_plot_group ( Str group ) {
    current_plot_group = group;
}

//#pragma GCC diagnostic push
//#pragma GCC diagnostic ignored "-Wunused-parameter"
template <> void QuantStudyContext<false>::plot_ohlc ( QuantReal, QuantReal, QuantReal, QuantReal, Str, Str, Str, Str, Str, bool ) {
}
//#pragma GCC diagnostic pop
...
template <> void QuantStudyContext<true>::plot_ohlc (
    //QuantPeriodization &per,
    QuantReal o,
    QuantReal h,
    QuantReal l,
...
//#pragma GCC diagnostic push
//#pragma GCC diagnostic ignored "-Wunused-parameter"
template <> void QuantStudyContext<false>::plot ( QuantReal, QuantReal, Str, Str, Str, Str, int, enum_plot_type, enum_line_style, bool ) {
}
//#pragma GCC diagnostic pop

template <> void QuantStudyContext<true>::plot (
    QuantReal value1,
    QuantReal value2,
    Str buffer_name,
    Str color1,
...
//#pragma GCC diagnostic push
//#pragma GCC diagnostic ignored "-Wunused-parameter"
template <> void QuantStudyContext<false>::plot ( QuantReal, Str, Str, int, enum_plot_type, enum_line_style, bool ) {
}
//#pragma GCC diagnostic pop
