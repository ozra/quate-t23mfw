...
void cerrbug_a_buffer(u8* byte_buffer, size_t byte_buffer_size)
{
    ...
    cerr << " AT BEGINNING:\n" << (int)byte_buffer[0] << ","
         << (int)byte_buffer[1] << "," << (int)byte_buffer[2] << ","
         << (int)byte_buffer[3] << ",\n" << (int)byte_buffer[4] << ","
         << (int)byte_buffer[5] << "," << (int)byte_buffer[6] << ","
         << (int)byte_buffer[7] << ",\n" << (int)byte_buffer[8] << ","
         << (int)byte_buffer[9] << "," << (int)byte_buffer[10] << ","
         << (int)byte_buffer[11] << ",\n" << (int)byte_buffer[12] << ","
         << (int)byte_buffer[13] << "," << (int)byte_buffer[14] << ","
         << (int)byte_buffer[15] << ",\n" << (int)byte_buffer[16] << ","
         << (int)byte_buffer[17] << "," << (int)byte_buffer[18] << ","
         << (int)byte_buffer[19] << "\n"
