...
should contain all basic math-functions in modified "wave-mode" (negative
sign is not natural number minus, but rather anti-node amplitude, in opposition
to node-amplitude)

no basic fn works with buffers. Just call buf(0) for gods sake!



wsqrt
wlog
wmax (this will return -7 > -1 !)
wmin
